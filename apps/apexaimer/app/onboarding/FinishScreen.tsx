        ...
        <View style={styles.benefits}>
          ...
          <OnboardingFadeInOutView style={styles.benefit} fadeInDelay={300}>
            ...
            <View style={styles.benefitTexts}>
              ...
              <Text style={styles.benefitDescription}>
                Prepare your body to the game by pumping blood to your muscles,
                speed up a nervous system and remember gaming mechanics.
              </Text>
            </View>
          </OnboardingFadeInOutView>
          <OnboardingFadeInOutView style={styles.benefit} fadeInDelay={400}>
            ...
            <View style={styles.benefitTexts}>
              <Text style={styles.benefitTitle}>Don’t Let Teammates Down</Text>
              <Text style={styles.benefitDescription}>
